...
Si aparece `404: NOT_FOUND`, revisa que el proyecto en Vercel apunte a la raiz del repositorio, no a una subcarpeta vacia. Esta version tambien incluye `index.html` en la raiz para que Vercel pueda servir la pagina aunque no tome `public/` como output.
